...
#include "tilemaps/springTilemap.h"
...
u16 *my_map = (u16*)(springBackgroundMap);
...
void tilemap(){
	// Load palette
    memcpy(pal_bg_mem, seasons_tilesetPal, seasons_tilesetPalLen);
    // Load tiles into CBB 0
    memcpy(&tile_mem[0][31], seasons_tilesetTiles, seasons_tilesetTilesLen);
    // Load map into SBB 30
    //load_map();
