...
{ 
	...
	"Let's go to the ceremony, it's like a coming of age thing i have to attend. There's some type of power I am supposed to be bestowed...Let's go!",
	//Textbox full of dialog two ->		better description that is searchable would be good here
  	"Oh no!, Something is wrong with this magic, it's sucking me in....nooo!!!!",
	//Textbox full of dialog three ->	better description that is searchable would be good here
  	"Hey, my name is *NAME*, Nice to meet you! Can you tell me how I can return to my form?",
	//Textbox full of dialog four ->	better description that is searchable would be good here
  	"Let's work together! Here we go!"
};
